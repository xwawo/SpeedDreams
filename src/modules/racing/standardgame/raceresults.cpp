/***************************************************************************
    ...
    version     : $Id: raceresults.cpp 7891 2022-01-09 16:29:56Z beaglejoe $
    ...
    switch (ReInfo->s->_raceType)
    {
        case RM_TYPE_RACE:
            ...
            for (i = 0; i < s->_ncars; i++)
            {
                ...
                GfParmSetStr(results, path, RE_ATTR_NATION, car->_nationname);
            ...
            if (s->_ncars == 1)
            {
                ...
                for (i = nCars; i > 0; i--)
                {
                        ...
                        && (car->_bestLapTime < opponentBestLapTime || opponentBestLapTime == 0.0))
                    {
                        ...
                        GfParmSetStr(results, path2, RE_ATTR_NATION,
                                     GfParmGetStr(results, path, RE_ATTR_NATION, ""));
